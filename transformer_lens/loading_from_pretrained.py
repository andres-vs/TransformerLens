...
OFFICIAL_MODEL_NAMES = [
    ...
    "andres-vs/bert-medium-finetuned_Att-Noneg-depth0",
    "andres-vs/bert-medium-finetuned_Att-Noneg-depth1",
    "andres-vs/bert-base-uncased-finetuned_Att-Noneg-depth2",
    "andres-vs/bert-base-uncased-finetuned_Att-Noneg-depth2_retrained1",
    "andres-vs/bert-base-uncased-finetuned_Att-Noneg-depth2_retrained2",
    "andres-vs/bert-base-uncased-finetuned_Att-Noneg-depth2_retrained3",
    "andres-vs/bert-base-uncased-finetuned_Att-Noneg-QDep0",
...
def convert_bert_weights(bert, cfg: HookedTransformerConfig):
    ...
    state_dict["head.W"] = mlm_head.transform.dense.weight
    state_dict["head.b"] = mlm_head.transform.dense.bias
    state_dict["head.ln.w"] = mlm_head.transform.LayerNorm.weight
    state_dict["head.ln.b"] = mlm_head.transform.LayerNorm.bias
